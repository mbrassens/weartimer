...
private const val HELLO_TILE_RESOURCES_VERSION = "1"
...
class HelloWorldTileService : TileService() {
    companion object {
        fun requestTileUpdate(context: Context) {
            getUpdater(context).requestUpdate(HelloWorldTileService::class.java)
        }
    }
    ...
    override fun onTileRequest(requestParams: RequestBuilders.TileRequest): ListenableFuture<TileBuilders.Tile> {
        ...
        val tileBuilder = TileBuilders.Tile.Builder()
            .setResourcesVersion(HELLO_TILE_RESOURCES_VERSION)
            .setTileTimeline(
    ...
    override fun onResourcesRequest(requestParams: RequestBuilders.ResourcesRequest): ListenableFuture<androidx.wear.tiles.ResourceBuilders.Resources> {
        val resources = androidx.wear.tiles.ResourceBuilders.Resources.Builder()
            .setVersion(HELLO_TILE_RESOURCES_VERSION)
            .build()
